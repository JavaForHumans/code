...
public abstract class AbstractCharacter  implements Character {
    ...
    static final String ACTION_ARCHER_FOUND_ARROWS = "action_archer_found_arrows";

    private final double MAX_HEALTH = 100.0;
    private final int MAX_EXPERIENCE = 8000;
    ...
    /*
            ...
            */
    {
        Character.actionExperiences.put(ACTION_LANDED_ATTACK, 200);
        Character.actionExperiences.put(ACTION_BLOCKED_ATTACK, 100);
        Character.actionExperiences.put(ACTION_ARCHER_FOUND_ARROWS, 50);
    }
    ...
    private int updateExperienceLevel() {
        ...
        if(experience <= (MAX_EXPERIENCE / 64)) { experienceLevel = 2; }
        else if (experience <= (MAX_EXPERIENCE / 32)) { experienceLevel = 3; }
        else if (experience <= (MAX_EXPERIENCE / 16)) { experienceLevel = 4; }
        else if (experience <= (MAX_EXPERIENCE / 8)) { experienceLevel = 5; }
        else if (experience <= (MAX_EXPERIENCE / 4)) { experienceLevel = 3; }
        else if (experience <= (MAX_EXPERIENCE / 2)) { experienceLevel = 4; }
        else if (experience <= MAX_EXPERIENCE) { experienceLevel = 5; }
        ...
        if(experienceLevel > currentLevel) {
            ...
            speak("New attack power = " + getAttackPower());
        }
